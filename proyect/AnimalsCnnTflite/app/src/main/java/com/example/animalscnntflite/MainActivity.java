...
public class MainActivity extends AppCompatActivity {
    ...
    int[] imgPixels = new int[IMG_SIZE*IMG_SIZE];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imgData = ByteBuffer.allocateDirect(4 * BATCH_SIZE * IMG_SIZE * IMG_SIZE * PIXEL_SIZE);
        /*
        * ByteBuffer representa la imagen como una matriz 1D con tres bytes por canal (rojo, verde y azul).
   ...
   * En efecto el método "addPixelValue" normaliza los pixeles escalandalos en [0.0,1.0]
